    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-3 left-4">
          <span className="text-xs tracking-[0.2em] uppercase text-cream/70 font-light">Assistir episódio</span>
        </div>
      </button>
    );
  }
                ...
                <ScrollReveal key={item.day} delay={i * 0.1}>
                  <div className="space-y-8">
                    ...
                    <div className="max-w-3xl mx-auto">
                      <YouTubeEmbed videoId={item.youtubeId} title={`${item.day} — ${item.title}`} />
                    </div>
                  </div>
                </ScrollReveal>
              );
