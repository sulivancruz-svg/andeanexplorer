      ...
      <div className="max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-muted-foreground font-extralight text-lg max-w-3xl mx-auto leading-relaxed">
        ...
        {/* Sede photo placeholder — replace src when image is uploaded */}
        {/* <ScrollReveal delay={0.1}>
          <div className="mb-16 rounded-lg overflow-hidden">
            <img
              src="/images/sede-vai-pro-mundo.jpg"
